...
fontmake -m text_inline_static.designspace -i -f -o ttf --output-dir ../fonts/ttf/static
fontmake -m display_inline_static.designspace -i -f -o ttf --output-dir ../fonts/ttf/static
