...
<details>
<summary><b>[161] BigShoulders[opsz,wght].ttf</b></summary>
<details>
...
* ⚠ **WARN** Instance "Text Thin": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text Thin": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Text Regular": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text Medium": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Text SemiBold": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text SemiBold": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Text ExtraBold": contains the following unparsable tokens "['Text']"
* ⚠ **WARN** Instance "Text ExtraBold": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Display Thin": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display Thin": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Display Regular": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display Regular": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display Medium": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display Medium": cannot determine instance name due to unparsable tokens
* ⚠ **WARN** Instance "Display SemiBold": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display SemiBold": cannot determine instance name due to unparsable tokens
...
* ⚠ **WARN** Instance "Display ExtraBold": contains the following unparsable tokens "['Display']"
* ⚠ **WARN** Instance "Display ExtraBold": cannot determine instance name due to unparsable tokens
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 1.100'] [code: version-not-detected]
...
* ℹ **INFO** This font contains the following optional tables [DSIG, prep, loca, GPOS, GSUB, gasp]
...
* 🍞 **PASS** BigShoulders[opsz,wght].ttf is named canonically.
...
* 🍞 **PASS** OS/2 VendorID 'HoP ' looks good!
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2019 The Big Shoulders Project Authors (https://github.com/xotypeco/big_shoulders)' matches canonical pattern.
